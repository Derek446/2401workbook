...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # select_related will fetch the submissions and the related assignment at the same time
        ...
        for submission in new_submissions:
            ...
            # Since we use select_related, the submission.assignment.title is in the query
