...
1. Let's take a look and add the `urls` of `announcements` to the project in the `announcements_project/urls.py` file.
...
2. Now, let's update the registration view to redirect to the announcement list view after successful registration.
