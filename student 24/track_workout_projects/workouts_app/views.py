...
from .serializers import(ExerciseSerializer, WorkoutSerializer, WorkoutDetailReadOnlySerializer,
...
class WorkoutViewSet(viewsets.ModelViewSet):
    ...
    # This is called only once. get_queryset is called each query and can be filtered.
